...
<div class="bjui-pageContent">
    <form:form class="nice-validator n-red" data-alertmsg="false"
        ...
        <table class="table table-condensed table-hover" width="100%">
            <tr>
                <td><label class="control-label x85" for="j_custom_name">名称：</label>
                    <form:input path="name" class="form-control" type="text"
                                ...
                                aria-required="true" data-rule="名称:required;length[~20, true]"
                                data-tip="请输入" data-ok="可用"/></td>
            </tr>
            <tr>
                <td><label class="control-label x85" for="j_custom_name">密码：</label>
                    <form:input path="pwd" class="form-control" type="text"
                                size="15" name="custom.pwd" style="width: 150px;"
                                aria-required="true" data-rule="密码:required;length[~20, true]"
                                data-tip="请输入" data-ok="可用"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label class="control-label x85" for="j_custom_name">邮箱：</label>
                    <form:input path="email" class="form-control"
                                size="15" name="custom.email" style="width: 150px;"
                                aria-required="true" data-rule="邮箱:length[~50, true]"
                                data-tip="请输入" data-ok="可用"/></td>
            </tr>
            <tr>
