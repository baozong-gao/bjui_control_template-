...
public class EmailController {
    ...
    public String verify(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            SysUserDAO userDO = ((List<SysUserDAO>) userService.search(form)).get(0);
            ...
            if (sendsuccess) {
                SysUserDAO userBO = new SysUserDAO();
    ...
    public boolean emailSend(int newPasswd, SysUserDAO userDO) {
